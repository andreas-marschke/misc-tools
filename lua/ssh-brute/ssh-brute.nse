...
description = [[
Bruteforce username and password for an ssh connection to a host.
]]
...
action = function(host, port)
  ...
  if #output > 0 then
   ...
   -- 	 local state,password_str = password
   -- 	 local state,username_str = username
	 
   -- 	 return state .. " " .. username_str .. " " .. state .. " " .. password_str 
   --    end
   --    usernames("reset")
   -- end
